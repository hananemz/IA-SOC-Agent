...
- `h: 10` â€” Compact bar charts (â‰¤7 items), fits above fold
- `h: 12-13` â€” Standard charts, timelines
- `h: 15+` â€” Detailed views, use below fold

### Layout Pattern: Operational Dashboard

```text
â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”  y:0
â”‚  Current State A      â”‚  Current State B      â”‚  h:10 (compact)
â”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”´â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¤  y:10
â”‚         Primary Timeline                      â”‚  h:12 (main trend)
â”œ â”€ â”€ â”€ â”€ â”€ â”€ â”€ FOLD â”€ â”€ â”€ â”€ â”€ â”€ â”€ â”€ â”€ â”€ â”€ â”€ â”€ â”¤  y:22 (1080p fold)
â”‚         Secondary Timeline                    â”‚  h:12 (below fold OK)
â”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¤  y:34
â”‚  Complementary 1      â”‚  Complementary 2      â”‚  h:10
...
2. **Compact heights**: Use h:10 for bar charts with â‰¤7 items
...
1. **Use JSON, not HJSON triple-quotes** â€” `'''` multi-line strings cause parse errors in Kibana; use single-line
   queries with escaped quotes `\"`
2. **Rename dotted fields** â€” `room.name` breaks Vega (interpreted as nested path); use ES|QL `RENAME room.name AS room`
3. **Don't set width/height** â€” use `autosize: { type: fit, contains: padding }`
4. **Set labelLimit on axes** â€” horizontal bar chart labels truncate; use `axis: { "labelLimit": 150 }`
5. **Sort bars by value** â€” pre-sort in ES|QL with `SORT field DESC` and use `sort: null` in encoding (preserves data
   order); avoid `sort: "-x"` in layered specs (bar + text labels) as it causes "conflicting sort properties" warnings
6. **Time axis: no rotated labels** â€” use `axis: { "labelAngle": 0, "tickCount": 8 }`, let Vega auto-format dates
7. **Descriptive titles replace axis titles** â€” good title/subtitle makes axis titles redundant; use `title: null` on
   axes
8. **Use color sparingly** â€” color is a precious visual attribute; use a single default color (`#6092C0`) for bar charts
   where position already encodes value; reserve color encoding for categorical distinction (e.g., multiple lines in a
   time series)
9. **Dark theme compatibility** â€” always include config to avoid bright white borders:
...
- [Dashboard Layout Reference](references/dashboard-layout-reference.md) â€” Grid system, layout patterns, design best
  practices
- [Vega-Lite Reference](references/vega-lite-reference.md) â€” Complete Vega-Lite grammar, chart patterns, best practices
- [ES|QL in Vega Reference](references/vega-esql-reference.md) â€” ES|QL data source configuration, time filtering,
  parameters
- [Example Specs](examples/) â€” Ready-to-use chart templates
